...
export const business = {
  name: "Infinite Tech",
  ownerName: "Jimmy",
  tagline: "IT solutions and projects for small businesses in Metro Vancouver",
...
export const legal = {
  priceDisclaimer:
    "Prices are estimates. We'll confirm your final price in writing before starting any work.",
  privacyNote:
